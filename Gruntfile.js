        ...
        copy: {
            docs: {
                files: [
                    ...
                    {
                        expand: true,
                        src: ['examples/assets/scripts/testComponent.js', 'examples/assets/scripts/fakeData.js', 'examples/assets/scripts/swapi.min.js', 'examples/assets/scripts/freezeframe.min.js', 'examples/assets/scripts/GriddleWithCallback.js'],
                        dest: 'docs/html/scripts',
                        flatten: true
                    }
                ]
            },
            modules: {
                files: [
                    {
                        expand: true,
                        src: ['compiled/columnProperties.js', 'compiled/rowProperties.js', 'compiled/deep.js'],
                        dest: 'modules',
                        flatten: true
                    }
                ]
